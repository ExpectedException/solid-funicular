...
def main():
    ...
    wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, 'div.account_setting_block:nth-child(6) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > a:nth-child(1)'))).click()
    wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, 'html.responsive body.v6.responsive_page div.responsive_page_frame.with_header div.responsive_page_content div.responsive_page_template_content div.page_body_ctn div#page_content.page_content.page_loaded div#wizard_contents div.wizard_content_wrapper a.help_wizard_button.help_wizard_arrow_right'))).click()
    ...
    wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, 'div.field-0-2-146:nth-child(7) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > input:nth-child(1)'))).send_keys(EmailOldPass)
    ...
    data = str(EmailNew + ' ' + EmailNewPass + ' ' + Steam + ' ' + SteamPassNew + '  '+ url + '     ' +  EmailOld + ' ' + EmailPassNew +'\n')
    f.write(data)
    f.close()
    ...
    wait.until(ec.element_to_be_clickable((By.XPATH, '/html/body/div/div[7]/div[2]/div[2]/div/div[2]/div/div[4]/form/div[3]/input'))).click()
    ...
    wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, '.user_avatar'))).click()
    driver.get('https://store.steampowered.com/account/')
    wait.until(ec.element_to_be_clickable((By.CSS_SELECTOR, 'div.account_setting_block:nth-child(4) > div:nth-child(1) > div:nth-child(3) > a:nth-child(1)'))).click()
